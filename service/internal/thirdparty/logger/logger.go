...
func NewSysLogger(in digIn) ILogger {
	return NewLogger(GetZapLevel(in.AppConf.GetAppLogConfig().Level), in.AppConf.GetAppLogConfig().Name, "SysLog", in.AppConf.GetAppLogConfig().Env)
}

func NewAppLogger(in digIn) ILogger {
	return NewLogger(GetZapLevel(in.AppConf.GetAppLogConfig().Level), in.AppConf.GetAppLogConfig().Name, "AppLog", in.AppConf.GetAppLogConfig().Env)
}
